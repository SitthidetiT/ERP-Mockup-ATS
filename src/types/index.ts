...
export interface QuotationImageBox {
  x: number;
  y: number;
  width: number;
  height: number;
...
export interface Quotation {
  ...
  drawingImageBox?: QuotationImageBox;
}
...
export interface StockMovement {
  ...
  itemId: string;
  itemName: string;
  type: "IN" | "OUT" | "ISSUE" | "RETURN" | "TRANSFER" | "ADJUST";
  qty: number;
  reference: string;
  user: string;
  lotNo?: string;
...
export type InquiryStatus =
  "NEW" | "UNDER_REVIEW" | "FEASIBLE" | "NEEDS_INFO" | "CLOSED";
...
export interface PurchaseOrder {
  ...
  unitPrice: number;
  expectedDate: string;
  status: "DRAFT" | "PENDING" | "APPROVED" | "PARTIAL" | "RECEIVED";
}
...
export interface ProductionOperation {
  ...
  qtyRework: number;
  qtyScrap: number;
  status: "WAITING" | "READY" | "IN_PROGRESS" | "PAUSED" | "QC" | "COMPLETED";
}
export interface ProductionOrder {
  ...
  planId: string;
  targetQty: number;
  status: "DRAFT" | "RELEASED" | "IN_PROGRESS" | "QC" | "COMPLETED";
...
export interface DeliveryRecord {
  ...
  deliveredQty: number;
  deliveryDate: string;
  status: "PREPARING" | "PARTIAL" | "DELIVERED";
  recipient?: string;
}
export interface JobCost {
  ...
  jobId: string;
  category:
    "MATERIAL" | "LABOUR" | "MACHINE" | "OUTSOURCE" | "REWORK" | "OTHER";
  description: string;
  estimated: number;
  actual: number;
}
...
export interface SalesFollowup {
  ...
  dueDate: string;
  contactedAt?: string;
  outcome: "SCHEDULED" | "WAITING" | "WON" | "LOST" | "REVISE";
  notes: string;
  owner: string;
}
export interface TradeOrder {
  ...
  unitCost: number;
  deliveredQty: number;
  status: "DRAFT" | "CONFIRMED" | "PARTIAL" | "DELIVERED";
}
